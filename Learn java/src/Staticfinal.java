...
class Student {
	...
	public void studentName() {//method
		System.out.println(name + " is enrolled in: " + studentClass);
	}

	public static void classInfo() {//method
...
Steven is enrolled in: Web Development Fundamentals
Daniel is enrolled in: Web Development Fundamentals
2.718281828459045
8
*/